...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2025 at 10:38 AM
...
--
CREATE DATABASE IF NOT EXISTS `itcenter_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `itcenter_db`;
...
(3, 'Wednesday', '10:30:00', '19:00:00', 'Open'),
(4, 'Thursday', '08:30:00', '19:00:00', 'Open'),
...
(1, 'Monday', '08:30:00', '19:00:00', 'Closed'),
(2, 'Tuesday', '08:30:00', '19:00:00', 'Open'),
(3, 'Wednesday', '08:30:00', '19:00:00', 'Closed'),
(4, 'Thursday', '08:30:00', '19:00:00', 'Open'),
(5, 'Friday', '08:30:00', '19:00:00', 'Closed'),
(6, 'Saturday', '09:00:00', '17:00:00', 'Closed'),
(7, 'Sunday', '09:00:00', '17:00:00', 'Closed');
...
-- Database: `musical`
--
CREATE DATABASE IF NOT EXISTS `musical` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `musical`;
...
CREATE TABLE `artist` (
  ...
  `artNationality` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `artist` (`artID`, `artName`, `artNationality`) VALUES
(1, 'Muse', 'British'),
(2, 'Mr. Scruff', 'British'),
(3, 'DeadMau5', 'Canadian'),
...
CREATE TABLE `cd` (
  ...
  `cdTitle` varchar(50) DEFAULT NULL,
  `cdPrice` decimal(5,2) DEFAULT NULL,
  `cdGenre` varchar(50) DEFAULT NULL,
  `cdRating` int(11) DEFAULT NULL,
...
INSERT INTO `cd` (`cdID`, `artID`, `cdTitle`, `cdPrice`, `cdGenre`, `cdRating`, `cdYear`) VALUES
...
(5, 4, 'Version', 12.99, 'Rock', 72, 2007),
(6, 5, 'Record Collection', 12.99, 'Pop', 22, 2010),
(9, 7, 'Come Around Sundown', 12.99, 'Rock', 88, 2010),
...
--
ALTER TABLE `cd`
  ADD CONSTRAINT `cd_ibfk_1` FOREIGN KEY (`artID`) REFERENCES `artist` (`artID`);
--
...
INSERT INTO `notices` (`id`, `title`, `content`, `category`, `date_posted`) VALUES
(2, 'Special Holiday', 'There will be a conferense going on from 2025/08/07 to 2025/08/13.Therefor university is close in these days.this is a vaccation period for the all Technology Students.', 'Holiday', '2025-08-07 13:33:21'),
(3, 'event', 'There Will be a Rugby tourment', 'Events', '2025-08-07 13:55:58');
